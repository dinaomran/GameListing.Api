...
public class UsersService(UserManager<ApplicationUser> userManager, IOptions<JwtSettings> jwtOptions) : IUsersService
{
    ...
    private async Task<string> GenerateToken(ApplicationUser user)
    {
        ...
        var token = new JwtSecurityToken(
            ...
            claims: claims,
            expires: DateTime.UtcNow.AddMinutes(Convert.ToInt32(jwtOptions.Value.DurationInMinutes)), // Don't use "DateTime.Now" it can cause issues when server is in different timezone
